          ...
          x={
            ...
            (viewType === "Monthly"
              ? index === 0
                ...
                ? -10
                : 0
              : 0) // Add padding only for Monthly View
          }
...
const InsightsScreen = () => {
  ...
  useEffect(() => {
    ...
    if (viewType === "Yearly" && chartData?.datasets) {
      ...
      viewType === "Monthly" &&
      groupedByMonth[selectedMonthIndex]?.length > 0
    ) {
    ...
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      <View style={styles.container}>
        ...
        <View style={styles.filterContainer}>
          <TouchableOpacity
            style={
              viewType === "Yearly" ? styles.activeFilter : styles.filterButton
            }
          ...
          <TouchableOpacity
            style={
              viewType === "Monthly" ? styles.activeFilter : styles.filterButton
            }
        ...
        {viewType === "Monthly" && (
          <View style={styles.filterContainer}>
            ...
            ) && ( // Hide Next Month button if it's December of the current year
              <TouchableOpacity
                style={styles.filterButton}
                onPress={() =>
              ...
              <LineChart
                ...
                labels={monthlyDetails[selectedMonthIndex]
                  ...
                  .map((entry) => {
                    ...
                    return `${
                      generateMonthLabels()[parseInt(month, 10) - 1]
                    } ${day}`; // Format as "Month DD"
                  })}
                datasets={topEmotions.map((emotion) => ({
                  data: monthlyDetails[selectedMonthIndex].map((entry) =>
                    entry.emotions.includes(emotion) ? 1 : 0
                  ), // 1 if the emotion exists, otherwise 0
          ...
          {pieChartData.length > 0 ? (
            <>
              ...
              <PieChart
                ...
                backgroundColor="#F5F0E8" // ADD COLOUR HERE SHANNON
                paddingLeft="15"
                style={{
                  fontFamily: "LexendDeca",
                  marginVertical: 8,
